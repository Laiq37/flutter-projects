...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (productId != null) {
        _editedProduct = productController.findById(productId as String).value;
        _initValues = {
  ...
  void _saveForm() async {
    ...
    if (_editedProduct.id != "") {
      ...
      cartController.updateCartItemDetail(
        _editedProduct.id,
        _initValues['title'] == _editedProduct.title
            ? null
            : _editedProduct.title,
        double.parse(_initValues['price']!) == _editedProduct.price
            ? null
